...
export class ProfilePage implements OnInit {
  ...
  constructor(private navCtrl: NavController, private modalCtrl: ModalController,private router: Router, private langandparmisionService: LangandparmisionService,) {}
  ngOnInit(): void {
